...
║│➸uso : responder imagem / gif / vídeo ou enviar imagem / gif / vídeo com legenda\n
   ════════════════════════════════════\n
║│➸comando : *${prefix}sticker nobg* ou *${prefix}stiker nobg* (bugado)
...
║│➸usage : *${prefix}gtts [cc] [text]*\nexample : *${prefix}gtts ja On2-chan*\n
   ════════════════════════════════════\n
║│➸command : *${prefix}loli*  (bugado)
║│➸desc : imagens aleatórias de loli
║│➸usage : apenas envie o comando\n
   ════════════════════════════════════\n
║│➸command : *${prefix}div*
║│➸desc : somente para transmisao 
║│➸usage : apenas envie o comando no privado so o dono do bot pode usar \n
   ════════════════════════════════════\n
║│➸command : *${prefix}simi*
